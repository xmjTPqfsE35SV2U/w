export default {
  ...
  'pages.login.welcome': 'خوش آمدید',
  'pages.login.success': 'ورود موفق!',
  'pages.login.username.label': 'نام کاربر',
  'pages.login.password.label': 'رمز‌گذاری',
  'pages.login.link.google': 'با گوگل وارد شوید',
  'pages.login.link.facebook': 'با فیسبوک وارد شوید',
  'pages.login.link.apple': 'با اپل وارد شوید',
  'pages.login.link.linkie': 'با لینکی وارد شوید',
