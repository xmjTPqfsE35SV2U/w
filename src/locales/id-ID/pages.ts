export default {
  ...
  'pages.login.link.google': 'Masuk menggunakan Google',
  'pages.login.link.facebook': 'Masuk menggunakan Facebook',
  'pages.login.link.apple': 'Masuk menggunakan Apple', // 注意: 在印尼语中，Apple 通常直接翻译为“Apple”
  'pages.login.link.linkie': 'Masuk menggunakan Linkie',
