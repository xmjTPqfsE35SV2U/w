export default {
  ...
  'pages.login.username.label': 'nome de utilizador',
  'pages.login.password.label': 'senha',
  'pages.login.welcome': 'Bem-vindo a',
  'pages.login.link.google': 'Entrar usando Google',
  'pages.login.link.facebook': 'Entrar usando Facebook',
  'pages.login.link.apple': 'Entrar usando Apple', // 注意: 在葡萄牙语中，Apple 通常直接翻译为“Apple”
  'pages.login.link.linkie': 'Entrar usando Linkie',
